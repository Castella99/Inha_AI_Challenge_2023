   ...
   and some other features helpful for model training and evaluation.
    ...
    def __init__(self, config, model):
        ...
        if self.config['pretrained'] :
            self.resume_checkpoint(self.config['pretrained_path'])
    ...
    def _train_epoch(self, train_data, epoch_idx, loss_func=None):
        ...
        for batch_idx, interaction in enumerate(train_data):
            ...
            losses = loss_func(interaction.cuda())
    ...
    def _valid_epoch(self, valid_data, is_test=False):
        ...
        Returns:
            ...
            dict: valid result
        """
        valid_result, df  = self.evaluate(valid_data, is_test=is_test)
        valid_score = valid_result[self.valid_metric] if self.valid_metric else valid_result['NDCG@20']
        return valid_score, valid_result, df
    ...
    def fit(self, train_data, valid_data=None, test_data=None, saved=False, verbose=True):
        ...
        for epoch_idx in range(self.start_epoch, self.epochs):
            ...
            if (epoch_idx + 1) % self.eval_step == 0:
                ...
                # test
                _, test_result, test_df = self._valid_epoch(test_data)
        ...
        return self.best_valid_score, self.best_valid_result, self.best_test_upon_valid, self.best_test_df
